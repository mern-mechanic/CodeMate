...
const Resume = () => {
    ...
    const [resumeData, setResumeData] = useState({
        ...
        skills: {
            frontend:
                'Angular, Angular Material, Typescript, RxJS, NgRx, HTML5/Pug, CSS3/SCSS, Bootstrap, Tailwind, JavaScript (ES6+), React, React Native, Electron, Next.js, Redux, JQuery, Daisy UI',
            ...
            testing: 'Jest, Jasmine, Karma, Protractor, Cypress, React Testing Library',
        ...
        experiences: [
            {
                ...
                technologies:
                    'React, Redux, Electron, Workbox, Tailwind, Node.js, Express, CouchDB, PouchDB, MongoDB, AWS, Amplify, Mixpanel, Telemetry, Data Dog',
            },
            {
                ...
                achievements: [
                    'Led large-scale enterprise frontend architecture using Angular with modular design and reusable components.',
                    'Boosted initial page load time by 30% through strategic lazy loading and AOT compilation.',
                    'Integrated Angular Material to standardize UI components across multiple platforms.',
                    'Used RxJS and NgRx for reactive data flows and global state management.',
                    'Streamlined payment processing by integrating Razorpay, Cashfree, and Decentro.',
                    'Optimized product discovery with custom filtering, sorting, and search algorithms.',
                    'Improved Lighthouse scores by enhancing Core Web Vitals and frontend performance.',
                    'Built secure and optimized Node.js microservices to support Angular frontend.',
                    'Collaborated with cross-functional teams to deliver pixel-perfect web solutions under tight deadlines.',
                ],
                technologies:
                    'Angular, Angular Material, RxJS, NgRx, Typescript, Node.js, Express, MongoDB, Docker, AWS, Git, Mixpanel, SSR, Jira',
            },
            {
                ...
                achievements: [
                    'Migrated legacy PHP Laravel application to a modular Angular-based SPA.',
                    'Created reusable Angular component libraries and internal access control modules.',
                    'Achieved 60% improvement in load performance using lazy loading and Brotli compression.',
                    'Published a custom NPM package for Angular-based user management.',
                    'Implemented Angular performance best practices including OnPush change detection and efficient DOM updates.',
                    'Led backend development of REST APIs for bot platform with JWT-based authentication.',
                ],
                technologies:
                    'Angular, Angular Material, Typescript, RxJS, HTML, CSS, Node.js, Express, MongoDB, Git, Jira, Icomoon, Brotli',
            },
            {
                company: 'Moglix, Noida',
                ...
                achievements: [
                    'Migrated CMS-based enterprise apps to Angular SPAs for improved maintainability and UX.',
                    'Used Angular Material for consistent UI and mobile responsiveness.',
                    'Built scalable Angular components and services for e-commerce workflows.',
                    'Integrated PrestaShop with custom Node.js APIs to enable real-time inventory sync.',
                    'Collaborated with QA and design teams to deliver production-grade Angular applications.',
                ],
                technologies:
                    'Angular, Angular Material, Typescript, Javascript, Bootstrap, HTML/Pug, CSS/SCSS, Node.js, Express, MongoDB, Prestashop, Wordpress, Git, Jira',
            },
            {
                ...
                achievements: [
                    "Developed and optimized 'Plan My Medical Trip' using AngularJS and Bootstrap.",
                    'Gained hands-on experience with AngularJS controllers, bindings, and directives.',
                    'Built backend forms and APIs with Node.js and Express.',
                ],
                technologies:
                    'AngularJS, Javascript, JQuery, HTML, CSS, Bootstrap, Node.js, Git, Jira',
            },
        ],
        education: [
            {
